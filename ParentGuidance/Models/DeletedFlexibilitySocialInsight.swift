//
//  DeletedFlexibilitySocialInsight.swift
//  ParentGuidance
//
...
// MARK: - Deleted Flexibility Social Insight Model

struct DeletedFlexibilitySocialInsight: Codable, Identifiable {
    let id: UUID
...
extension DeletedFlexibilitySocialInsight {
    init(
    ...
    func toChildRegulationInsight() -> ChildRegulationInsight {
        return ChildRegulationInsight(
            ...
            category: .mildAutism, // Flexibility & Social Understanding maps to .mildAutism
            content: content
        )
    }
}