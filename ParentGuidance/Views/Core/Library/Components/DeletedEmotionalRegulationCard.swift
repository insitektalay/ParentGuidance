//
//  DeletedEmotionalRegulationCard.swift
//  ParentGuidance
//
...
struct DeletedEmotionalRegulationCard: View {
    let deletedInsight: DeletedEmotionalRegulationInsight
    let onRestore: () -> Void
    ...
    var body: some View {
        ...
        .background(SemanticColors.cardBackground.opacity(0.7)) // Slightly darker than regular cards
        .overlay(
...
#Preview {
    let sampleDeletedInsight = DeletedEmotionalRegulationInsight(
        id: UUID(),
    ...
    return DeletedEmotionalRegulationCard(
